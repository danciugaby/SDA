...
\usepackage{titling}                    % fancy titles with prefix and suffix
           ...
           % allows limited support for non-ascii UTF8 codes in text
\usepackage{graphicx}                   % graphics driver support (math/images for PDFs)



% Support for non-english typesetting
...
\newcommand{\PrintAuthorIndex}{
  \ifthenelse{\boolean{NOAUTHORS}}{}{%
    ...
    \RunningHeads{Lista cu autorii citați}
    \chapter*{Lista cu autorii citați}%
    \addcontentsline{toc}{chapter}{Lista cu autorii citați}%
...
\newcommand{\ChapterNotesName}[1]{%
  \ifthenelse{\boolean{CHAPTERNOTES}}{%
    ...
    \addtoendnotes{
      %\bigskip\StopIndent
      \large\textsf{Capitolul \thechapter\, --- #1}
      \normalsize\normalfont\bigskip
    }
  }%    
}
...
\newcommand{\BookEndNotes}{%
  \ifthenelse{\boolean{CHAPTERNOTES}}{}{%
    \cleardoublepage\phantomsection%
    \addcontentsline{toc}{chapter}{Rezumate pe capitole}%
    \theendnotes%
  }%
}
...
\newcommand{\listsourcename}{Lista cu sursele imaginilor}
