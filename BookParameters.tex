...
\def\TheMainTitle{Structuri de date și algoritmi}
\def\TheSubTitle{aplicații practice}
%\def\TheSubTitleA{Aplicaț}
%\def\TheSubTitleB{Why Not Read This One?}
\def\TheBookSeries{Books That Are Really Odd Series}

\def\TheAuthor{Gabriel M. Danciu}
\def\TheAuthorA{Gabriel}
\def\TheAuthorB{Danciu}
\def\TheAuthorLNF{Danciu, Gabriel, M.}

\def\TheCopyrightYear{2017}
\def\TheEdition{Prima Ediție}

\def\ThePublisherName{Editura Universitatii Transilvania}% Just the short form name
\def\ThePublisherLineA{Editura}% Just one part of the name
\def\ThePublisherLineB{ Universitatii Transilvania}% Just one part of the name
\def\ThePublisher{\ThePublisherName}% Add Ltd, Inc, LLC etc here
\def\ThePublisherAddrA{Str. Iuliu Maniu nr. 41A Braşov}
\def\ThePublisherAddrB{Brașov, 500091}
\def\ThePublisherCity{Brașov}
\def\ThePublisherState{România}

\def\ThePrinter{Editura Universitatii Transilvania}

\def\TheSubjectArea{Algoritmi, Structuri de date, Aplicații}

\def\TheKeywords{Algoritmi, Structuri, Programare, Aplicații}
