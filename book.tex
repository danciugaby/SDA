...
\Boolean{CHAPTERNOTES}{false}     % Place endnotes at end of each chapter
...
\begin{center}
  \vspace*{2in}
  \vspace*{1in}
  \epigraph{There is no silver bullet}{\textit{Fred Brooks}}
\end{center}
...
\renewcommand*\contentsname{\huge{Cuprinsul detaliat}}
...
\begingroup% Isolate these changes to just the shorttoc command.
	...
	\pdfbookmark[1]{Cuprins}{toc}%
	\shorttoc{Rezumatul cuprinsului}{0}% Tighter spacing, Chapter names only.
\endgroup%
...
\ifthenelse{\boolean{NOLISTS}}{}{%
  ...
  \ifthenelse{\boolean{NOTABLIST}}{}{%
    \addcontentsline{toc}{chapter}{Lista de tabele}%
    \listoftables%
  }%
}%
%% ----------------------------------------------------------------------------
...
\ChapterPrefix%
\input{tex/Programaredinamica.tex}%

\ChapterPrefix%
\input{tex/StringMatching.tex}%

\ChapterPrefix%
\input{tex/BackTracking.tex}%

\ChapterPrefix%
\input{tex/Metodeiterative.tex}%
...
\ifthenelse{\boolean{NOLISTS}}{}{%
  ...
  \ifthenelse{\boolean{NOFIGLIST}}{}{%
    ...
    \ifthenelse{\boolean{NOFIGSRCS}}{}{%
      ...
      \addcontentsline{toc}{chapter}{Sursele imaginilor}%
      \listofsources
...
\ifthenelse{\boolean{NOABBR}}{}{
  \newpage
  \addcontentsline{toc}{chapter}{Abrevieri și simboluri}
  \PrintAcronyms%
}%
%
%% ----------------------------------------------------------------------------
